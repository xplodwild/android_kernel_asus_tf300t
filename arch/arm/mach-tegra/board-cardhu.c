...
/* Higher freq could be applied for TF300T/TF300TG Camera FW update*/
...
static void cardhu_i2c_init(void)
{
	...
	if(project_info == TEGRA3_PROJECT_TF300T || project_info == TEGRA3_PROJECT_TF300TG){
...
static void cardhu_usb_init(void)
{
	...
	if (bi.board_id == BOARD_PM267) {
		...
		//Disable the usb2 host controller for wifi version. But the part is must enabled for 3G version.
