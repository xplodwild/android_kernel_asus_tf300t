...
static __initdata struct tegra_pingroup_config cardhu_pinmux_cardhu[] = {
	...
	/*TP_IRQ*/
	DEFAULT_PINMUX(GMI_CS4_N,       GMI,             PULL_DOWN,   NORMAL,     INPUT),
	/*PCIE dock detect*/
	DEFAULT_PINMUX(GPIO_PU4,        PWM1,            PULL_UP,   NORMAL,     INPUT),
};
...
static __initdata struct tegra_pingroup_config cardhu_pinmux_common_3g[] = {
...
int __init cardhu_pinmux_init(void)
{
	...
	if (project_info == TEGRA3_PROJECT_TF300TG) {
		tegra_pinmux_config_table(cardhu_pinmux_common_3g,
				ARRAY_SIZE(cardhu_pinmux_common_3g));
	}
