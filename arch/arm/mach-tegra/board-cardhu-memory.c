...
static const struct tegra_emc_table TF300T_Elpida_1GB_EDJ2108EDBG_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
	...
	case BOARD_E1257:
		if (MEMORY_TYPE(board.sku) == SKU_MEMORY_ELPIDA)
			...
			if(project_info == TEGRA3_PROJECT_TF300T)
			{
				...
				{
					printk("BOARD_PM269:TF300T_Elpida_1GB_EDJ2108EDBG_667MHZ\n");
					tegra_init_emc(TF300T_Elpida_1GB_EDJ2108EDBG_667MHZ,
						ARRAY_SIZE(TF300T_Elpida_1GB_EDJ2108EDBG_667MHZ));
				}
